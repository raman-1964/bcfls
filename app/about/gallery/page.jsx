  ...
  return (
    <div className="w-full mx-auto pb-5">
      ...
      <div className="max-w-[1320px] mx-auto">
        ...
        <div className="px-4 md:px-0 max-w-full w-[1020px] mx-auto z-30 -mt-[100px] md:-mt-[70px] relative md:rounded-2xl overflow-hidden">
          {/* <div className="animate-pulse z-10 absolute top-0 left-0 duration-50 w-[1020px] md:bg-gray-100 mx-auto rounded-2xl"></div> */}
          <div className="grid grid-cols-3 gap-3 w-full">
            {[...Array(8).keys()].map(() => (
              <div className="flex shadow-sm hover:scale-[1.01] hover:shadow-lg group border border-gray-300/70 mx-auto md:flex-col md:justify-start bg-white p-2 md:my-0 md:mt-0 lg:mb-0 lg:my-0  transition-all duration-300 rounded-2xl font-inter w-full max-w-[490px]">
